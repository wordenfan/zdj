     ...
     <div class="memberR_cnt">
      <div class="mem_info_btm">
       <table class="mem_order_lists" cellpadding="0" border="0" cellspacing="0">
		...
		<tr>
			<td class="order_number"><a target="_blank" href="<?php echo base_url('home/order/orderinfo/oid/'.(strlen($vo['oid'])>6?$vo['oid']:$vo['snid']));?>"><?php echo (strlen($vo['oid'])>6?$vo['oid']:$vo['snid']);?></a></td>
