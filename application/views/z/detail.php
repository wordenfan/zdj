...
<div class="detail_wrap">
	<section data-am-widget="accordion" class="am-accordion am-accordion-default">
			...
			<dl class="am-accordion-item">
                <dt class="am-accordion-title" style="background-color:#EEEEEE;color:#e65210">
				...
				<dd class="am-accordion-content">
					...
					&nbsp&nbsp&nbsp&nbsp	
                    <?php if($data[0]['order_status'] == 1):?>
                    订单管理：<a href="<?php echo $_SERVER['HTTP_HOST'].'admin/order/operate/oid/'.$data[0]['oid'].'/stu/2/source/weixin';?>" style="color:#ff0000;text-decoration:underline">☜撤销☞</a>
					<?php else:?>
                    订单管理：<a href="<?php echo $_SERVER['HTTP_HOST'].'admin/order/operate/oid/'.$data[0]['oid'].'/stu/1/source/weixin';?>" style="color:#008000;text-decoration:underline">☜接单☞</a>
					<?php endif;?><br>
